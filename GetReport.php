...
$res = mysqli_query($connn,"select date from transaction where test_id = $test_id and tr_id=$tr_id");
$pdtl = mysqli_fetch_assoc($res);
$sdate = strtotime($pdtl['date']);
...
$pdf ->Ln(4);
$pdf-> Cell(5, 5, "Sample Taken Date : $sdate", 0, 0, '');
$pdf ->Ln(4);
$pdf-> Cell(5, 5, "Report Date : $date", 0, 0, '');
