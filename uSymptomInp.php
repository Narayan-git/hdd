<?php
    ...
    if(isset($_SESSION['is_login'])){
        ...
        $pid =$_GET['pid'];
        $query = "select name from profile where pid=$pid";
...
<?php require "include/header.php"; ?>
    <div class="container ">
        <br />
        <h3 class="text-center">Select Your Symptoms </h3>
        <br />
        <div style="width:100%; max-width: 800px; margin:0 auto;">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="post" action="uGetDiseaseReport.php?pid=<?php echo $pid;?>" id="repeater_form" target="blank">
                        <div class="form-group">
                            <label>Patient Name</label>
                            <input type="text" name="name" id="name" class="form-control" value='<?php echo $pname;?>' readonly />
                        </div>
                        <div id="repeater">
