...
<body>
    ...
    <div class="cards">
        <div class="row mb-4 p-5">
            ...
            <a href="uPatientDetail.php" class="card-link">
            <div class="card mb-4" style="width: 18rem;">
                <div class="card-body">
                    <h5 class="card-title">PATIENTS DETAIL</h5>
                        <p class="card-text">Toatal  
                            <?php 
                                $query ="select count(pid) as p from profile where uid=$uid";
                                $result = mysqli_query($connn, $query);
                                $count = mysqli_fetch_assoc($result);
                                echo $count['p'];
                            ?> 
                        Date : <?php echo date("d - m - Y");?> </p>
                    <a href="uPatientDetail.php" class="cb card-link btn btn-primary">All Detail</a>
                </div>
            </div>
            </a>
            </div>
