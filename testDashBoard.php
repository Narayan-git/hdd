...
<body>
    ...
    <div class="row mb-4 p-5">
        ...
        <a href="adminAllTestDetail.php" class="card-link">
        <div class="card mb-4" style="width: 18rem;">
            <div class="card-body">
                ...
                <a href="adminAllTestDetail.php" class="cb card-link btn btn-primary">All Detail</a>
            </div>
        </div>
        </a>
        </div>
        <!-- card 2 -->
        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
        <a href="adminPendingTest.php" class="card-link">
        <div class="card mb-4" style="width: 18rem;">
            <div class="card-body">
                <h5 class="card-title">PENDING TEST CASES</h5>
                    ...
                    <?php 
                        ...
                        ?>
                    Date :  <?php echo date("d - m - Y");?> </p>
                <a href="adminPendingTest.php" class=" cb card-link btn btn-primary">Pending</a>
            </div>
        </div>
        </a>
        </div>
        <!-- card 3 -->
        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
        <a href="adminTdTest.php" class="card-link">
        <div class="card mb-4" style="width: 18rem;">
            <div class="card-body">
                <h5 class="card-title">TODAY'S TEST CASES</h5>
                    <p class="card-text">Total  
                    <?php 
                            $query ="select count(tr_id) as cnt from transaction where DATE(date) = CURDATE()";
                            $result = mysqli_query($connn, $query);
                            $count = mysqli_fetch_assoc($result);
                            echo $count['cnt'];
                        ?>
                    </p>
                <a href="adminTdTest.php" class=" cb card-link btn btn-primary">TODAY</a>
            </div>
        </div>
        </a>
        </div>
        <!-- card 4 -->
        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
        <a href="adminTdPending.php" class="card-link">
        <div class="card mb-4" style="width: 18rem;">
            <div class="card-body">
                <h5 class="card-title">TODAY'S PENDING TEST CASES</h5>
                    <p class="card-text">Total  
                    <?php 
                            $query ="select count(tr_id) as cnt from transaction where DATE(date) = CURDATE() and status=0";
                            $result = mysqli_query($connn, $query);
                            $count = mysqli_fetch_assoc($result);
                            echo $count['cnt'];
                        ?>
                    </p>
                <a href="adminTdPending.php" class="cb card-link btn btn-primary">Pending Today</a>
            </div>
        </div>
        </a>
        </div>
        ...
        <div class="row mb-4 p-5">
            <!-- card 5 -->
            <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                <!-- <a href="#NewTestAdd" data-target="#NewTestAdd" class="card-link"> -->
                    ...
                    <div class="card-body">
                        <h5 class="card-title">MANAGE TESTS</h5>
                            ...
                            <?php 
                                    ...
                                    $result = mysqli_query($connn, $query);
                                    $count = mysqli_fetch_assoc($result);
                                    echo $count['cnt']." Tests";
                                ?>
                            </p>
                            <button type="button" class="btn btn-success mb-2" data-toggle="modal" data-target="#NewTestAdd">ADD NEW TEST</button>
                            <a href="adminViewTest.php" class="btn btn-primary btn-sm">Wiew Test Detail</a>
                    </div>
                </div>
                <!-- </a> -->
            </div>
